...
```txt
관리자: admin@workrag.demo / admin1234
일반 사용자: user@workrag.demo / user1234
```

관리자는 전체 문서/로그/사용자 권한을 볼 수 있고, 일반 사용자는 본인 대화 히스토리와 접근 허용 문서만 볼 수 있습니다.
